...
public class LisInitialModeIterator implements JobBatchIterator<LicenseNumberSavePoint> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(LisInitialModeIterator.class);
  ...
  private List<ChangedEntityIdentifier<LicenseNumberSavePoint>> getNextPage() {
    return changedEntitiesIdentifiersService.getIdentifiersForInitialLoad(lastId);
  }
