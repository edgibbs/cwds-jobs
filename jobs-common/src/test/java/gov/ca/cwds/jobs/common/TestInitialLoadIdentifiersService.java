...
public class TestInitialLoadIdentifiersService extends AbstractTestChangedIdentifiersService {

  public TestInitialLoadIdentifiersService(
  ...
  public List<ChangedEntityIdentifier<TimestampSavePoint<LocalDateTime>>> getIdentifiers(
    ...
    return getNextPage(pageRequest, getIdentifiers());
  }
