...
public class AuditEventsJobTest {
  ...
  private static LocalDateTime SAVEPOINT_1 = LocalDateTime.of(2000, 7, 25, 11, 0, 10);
  private static LocalDateTime SAVEPOINT_2 = LocalDateTime.of(2001, 9, 25, 11, 0, 10);
  private static LocalDateTime SAVEPOINT_3 = LocalDateTime.of(2003, 10, 11, 9, 54, 8);
  ...
  private void runLoad(JobMode jobMode) {
    ...
    AuditEventsJobConfiguration jobConfiguration = JobConfiguration.getJobsConfiguration(
        AuditEventsJobConfiguration.class, jobOptions.getConfigFileLocation());
    ...
    AuditEventsJobModule auditEventsJobModule =
        new TestAuditEventsJobModule(jobConfiguration, jobMode);
  ...
  private void addDataForIncrementalLoad() throws LiquibaseException {
    ...
    getDatabaseHelper().runScript("liquibase/ns_audit_events_incremental_data.xml", parameters,
        "ns");
  ...
  private static String getConfigFilePath() {
    return Paths.get("src", "test", "resources", "audit-events-test.yaml").normalize()
        .toAbsolutePath().toString();
  }

  private static AuditEventsJobConfiguration getJobConfiguration() {
    AuditEventsJobConfiguration configuration = JobConfiguration
  ...
  private static DatabaseHelper getDatabaseHelper() {
    ...
    return new DatabaseHelper(nsDataSourceFactory.getUrl(), nsDataSourceFactory.getUser(),
  ...
  class TestAuditEventsJobModule extends AuditEventsJobModule {
    ...
    public TestAuditEventsJobModule(AuditEventsJobConfiguration jobConfiguration, JobMode jobMode) {
